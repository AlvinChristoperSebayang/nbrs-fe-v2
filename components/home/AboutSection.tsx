...
export function AboutSection() {
  return (
    <section className="section-about flex flex-col lg:flex-row pb-[100px]  ">
      <div className="bg-[#070F0F] w-full h-full">
        ...
        <div className="flex flex-col justify-center gap-6  pr-5 py-16 lg:w-2/5  lg:pt-24 lg:pb-60 lg:max-w-[315px]">
          ...
          >
            Designing Environments That Shape Lives
          </h2>
          <p data-aos="fade-up" data-aos-delay="150" className="max-w-md text-white/70">
            Working collaboratively with clients and communities to create
            enduring, human-centred places
          </p>
        </div>
        ...
        >
          <img
            ...
            alt="NBRS project — building exterior"
