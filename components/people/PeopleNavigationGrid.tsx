          ...
          >
            ...
            <div className="lg:col-span-8 flex flex-col justify-between gap-6 p-6 sm:p-8 lg:p-8 xl:p-12 pt-8 sm:pt-10 lg:pt-10 xl:pt-14 min-h-[250px]">
              <div className="flex flex-col gap-3">
                ...
                <span
                  className="font-heading hidden lg:block text-3xl lg:text-[40px] xl:text-[44px] font-bold uppercase tracking-wide leading-none text-rose-200"
                >
                  {teamCard.title}
                </span>

                <p className="font-sans text-base sm:text-lg lg:text-xl text-white/90 leading-relaxed max-w-xl mt-1 sm:mt-2">
          ...
          {gridCards.map((card, index) => (
            <div key={card.id} data-aos="fade-up" data-aos-delay={index * 100}>
              ...
              >
                ...
                <div
                  className={`w-full h-2.5 ${ACCENTS[index + 1] ?? ACCENTS[0]} lg:hidden absolute top-0 left-0 right-0 z-20`}
                />
                ...
                <div className="hidden lg:flex relative z-10 mt-auto items-end justify-between gap-2 lg:gap-4 text-white w-full">
                  <h3 className="font-heading text-lg lg:text-xl xl:text-2xl font-bold uppercase leading-tight tracking-wide text-white transition-colors duration-300 group-hover:text-rose-100">
                    {card.title}
                  </h3>
                  <svg
                    viewBox="0 0 24 24"
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="w-5 h-5 lg:w-6 lg:h-6 shrink-0 mb-0.5 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-2"
                  >
                    <path d="M5 12h14M12 5l7 7-7 7" />
                  </svg>
                </div>
