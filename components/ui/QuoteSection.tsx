      ...
      <Container className="uncontainer-mobile overflow-hidden max-md:px-0">
        <div className="relative flex flex-col lg:block">
          ...
          <div
            data-aos="fade-up"
            data-aos-delay="150"
            className={`flex flex-col justify-between ${boxBgClass} p-8 sm:mx-6 sm:p-10 lg:absolute lg:top-1/2 lg:right-0 lg:mx-0 lg:w-[50%] lg:-translate-y-1/2 lg:p-12 shadow-sm border border-white/80`}
          >
