      ...
      <Container className="max-lg:px-0 max-lg:max-w-none">
        <div className="relative flex flex-col items-center lg:block">
          ...
          >
            {/* Top Quote Icon */}
            <span
              className="font-serif text-4xl leading-none lg:text-5xl xl:text-6xl mb-2 text-white lg:text-[var(--quote-icon-color)]"
            ...
            >
              <svg
                ...
                className="w-8 h-6 lg:w-10 lg:h-8 xl:w-12 xl:h-9"
              >
                <path
            ...
            <span
              className="self-end font-serif text-4xl leading-none lg:text-5xl xl:text-6xl mt-2 text-white lg:text-[var(--quote-icon-color)]"
              style={{ "--quote-icon-color": quoteIconColor } as React.CSSProperties}
            >
              <svg
                viewBox="0 0 56 42"
