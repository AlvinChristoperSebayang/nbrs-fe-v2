...
const fallbackFooter: FooterContent = {
  ...
  navigation: [
    ["purpose", "About NBRS", "/purpose/about-us"],
    ["purpose", "Design Approach", "/purpose/insights/design-approach"],
    ["purpose", "Research", "/purpose/insights/research"],
    ["purpose", "Awards", "/purpose/insights/awards"],
    ["purpose", "Sustainability", "/purpose/sustainability"],
    ["purpose", "Social Responsibility", "/purpose/social-responsibility"],
    ["purpose", "News", "/news"],
    ["people", "Our Leaders", "/people/team"],
    ["people", "Culture", "/people/culture"],
    ["people", "Careers", "/people/careers"],
    ["people", "Envision", "/people/envision-student-partnership-program"],
    ["sectors", "Education", "/sector/education"],
    ["sectors", "Wellness", "/sector/wellness"],
    ["sectors", "Community", "/sector/community"],
