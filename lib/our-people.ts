...
const image = `mobile: url @transform(width: 1440, mode: "fit", format: "webp", quality: 85, immediately: true) tablet: url @transform(width: 1440, mode: "fit", format: "webp", quality: 82, immediately: true) desktop: url @transform(width: 2400, mode: "fit", format: "webp", quality: 85, immediately: true)`;
const cardImage = `mobile: url @transform(width: 1024, mode: "fit", format: "webp", quality: 80, immediately: true) tablet: url @transform(width: 1024, mode: "fit", format: "webp", quality: 82, immediately: true) desktop: url @transform(width: 1200, mode: "fit", format: "webp", quality: 85, immediately: true)`;
