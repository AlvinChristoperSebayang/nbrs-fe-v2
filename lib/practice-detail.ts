...
const introImage = `mobile: ${fit(1440, 82)} tablet: ${fit(1440, 82)} desktop: ${fit(1920, 85)}`;
const sectorCardImage = `mobile: ${fit(1200, 85)} tablet: ${fit(900, 82)} desktop: ${fit(1200, 85)}`;
