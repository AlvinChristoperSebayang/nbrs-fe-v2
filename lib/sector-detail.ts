...
const crop = (width: number, height: number, quality = 85) => `url @transform(width: ${width}, height: ${height}, mode: "crop", format: "webp", quality: ${quality}, immediately: true)`;
...
const cardImage = `mobile: ${crop(900, 720)} tablet: ${crop(900, 720, 82)} desktop: ${crop(1200, 960, 85)}`;
