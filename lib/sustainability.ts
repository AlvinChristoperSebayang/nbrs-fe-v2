        ...
        blocks {
          ...
          ... on blocks_text_BlockType {
            ...
            image {
              ...
              width
              height
              mobile: url @transform(width: 1200, mode: "fit", format: "webp", quality: 80, immediately: true)
              tablet: url @transform(width: 1200, mode: "fit", format: "webp", quality: 80, immediately: true)
              desktop: url @transform(width: 1440, mode: "fit", format: "webp", quality: 85, immediately: true)
              title
            }
          }
